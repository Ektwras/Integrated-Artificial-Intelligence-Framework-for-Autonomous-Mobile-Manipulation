...
def generate_launch_description():
    ...
    launch_arg_imu_filter = DeclareLaunchArgument(
        'imu_filter',
        default_value='/home/ektoras/ros2_clearpath_ws/platform/config/imu_filter.yaml',
        description='')
        ...
        launch_arguments=
            [
                (
                    'setup_path'
                    ,
                    '/home/ektoras/ros2_clearpath_ws/'
                )
                ,
                (
                    'use_sim_time'
            ...
            [
                {
                    'use_sim_time': True
                    ,
                    'config_file': '/home/ektoras/ros2_clearpath_ws/sensors/config/imu_0.yaml'
                    ,
                }
                ,
            ]
            ...
            [
                {
                    'use_sim_time': True
                    ,
                    'config_file': '/home/ektoras/ros2_clearpath_ws/sensors/config/gps_0.yaml'
                    ,
                }
                ,
            ]
